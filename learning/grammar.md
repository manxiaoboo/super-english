...
|---|---|---|---|---|---:|---|
| because of + noun / because + clause | 表达原因时正确选择 because of 和 because。 | reviewing | 2026-07-06 | 2026-07-10 | 1 | hard |
| A is the expression of B | 用来说明 A 是 B 的外在体现、呈现或表达。 | reviewing | 2026-07-06 | 2026-07-15 | 1 | good |
| two complete clauses need a linker | 说明两个完整句子不能只用逗号硬连，需要 and、but、so、where 等连接方式 | new | 2026-07-08 | 2026-07-09 | 0 | learned |
| probability expressions scale | 表达可能性大小的词汇对比（definitely / probably / likely to / maybe / might） | reviewing | 2026-07-09 | 2026-07-14 | 1 | hard |
